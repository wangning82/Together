...
<%@ attribute name="placeholder" type="java.lang.String" required="false" description="输入框占位符" %>
...
<input type="text" id="${name}" name="${name}" placeholder="${placeholder}" maxlength="5" class="txt required"
       style="padding: 4px 6px; width:45px;${inputCssStyle}"/>
