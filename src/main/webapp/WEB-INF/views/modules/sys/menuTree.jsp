...
<body> --%>
<%--<div class="userInfo" style="background-color: #ffffff; padding-bottom: 20px;">--%>
<%--<div class="controls" style="text-align: center;">--%>
<%--<img src="${fns:getUser().photo}" style="max-width: 140px; max-height: 140px;" alt="暂无头像">--%>
<%--</div>--%>
<%--<div class="controls" style="text-align: center; margin-top: 20px;">--%>
<%--<a href="#" target="mainFrame"--%>
<%--title="个人信息" style="text-align: center;">您好, ${fns:getUser().name}&nbsp;--%>
<%--</a>--%>
<%--</div>--%>
<%--</div>--%>
<div class="accordion" id="menu-${param.parentId}" style="height: auto; margin-top: 10px;">
    <c:set var="menuList" value="${fns:getMenuList()}"/>
    <c:set var="firstMenu" value="true"/>
    <c:forEach items="${menuList}" var="menu" varStatus="idxStatus">
        <c:if test="${menu.parent.id eq (not empty param.parentId ? param.parentId:1)&&menu.isShow eq '1'}">
            <div class="accordion-group" style="margin-left: 10px; margin-right: 10px;">
                <div class="accordion-heading">
                    <a class="accordion-toggle" data-toggle="collapse" data-parent="#menu-${param.parentId}"
                       ...
                       style="color: #555; background-color: #ffffff;">
                            <%--
                            <i class="icon-chevron-${not empty firstMenu && firstMenu ? 'down' : 'right'}">
                            --%>
                        <i class="icon-chevron-${not empty firstMenu && firstMenu ? 'right' : 'right'}">
                        </i>&nbsp;${menu.name}
                    </a>
                </div>
                    <%-- 默认折叠所有菜单
                ...
                <div id="collapse-${menu.id}"
                     class="accordion-body collapse ${not empty firstMenu && firstMenu ? '' : ''}">
