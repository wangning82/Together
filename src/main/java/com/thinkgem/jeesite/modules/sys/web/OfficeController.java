...
//        model.addAttribute("list", officeService.findAll());
    ...
    public String list(@RequestParam(required = false) String id, @RequestParam(required = false) String parentId,
                       @RequestParam(required = false) String parentIds, Office office, Model model) {
        if (StringUtils.isNotBlank(id)) {
            office.setId(id);
        }
