...
//    // 手机端菜单缓存
//    public static final String MOBILE_CACHE_MENU_LIST = "mobileMenuList";
//    // 手机端角色列表缓存
//    public static final String MOBILE_CACHE_ROLE_LIST = "mobileRoleList";
//    // 手机端区域列表缓存
//    public static final String MOBILE_CACHE_AREA_LIST = "mobileAreaList";
//    // 手机端公司列表缓存
//    public static final String MOBILE_CACHE_OFFICE_LIST = "mobileOfficeList";
    ...
    /**
     * 手机端根据登录名获取用户信息，此处不能调用UserUtils,因为那会判断shiro，
     * 手机端不通过shiro的管理，
     *
     * @param loginName
     * @return
     * @Author HL
     */
    public User getUserByMobileLoginName(String loginName) {
     ...
     * @return
     */
    public List<User> findUserByMobile(User user) {
        List<User> list = userDao.findUserByMobile(user);
        return list;
    }
...
//		systemRealm.clearAllCachedAuthorizationInfo();
    ...
    /**
     * 手机端获取当前用户授权的菜单列表，不能调用UserUtils类，所以需要传递用户信息
     *
     * @return
     * @Author HL
     */
    public List<Menu> findMobileAllMenu(String token, User user) {
        // 先检查是否有缓存
        List<Menu> menuList = new ArrayList<Menu>();
//        if (StringUtils.isNotBlank(token)) {
//            menuList = (List<Menu>) EhCacheUtils.get(MOBILE_CACHE_MENU_LIST, token);
//        }
...
//                        EhCacheUtils.put(MOBILE_CACHE_MENU_LIST, token, menuList);
//                    }
//
//                }
            }
    ...
    /**
     * 手机端获取当前用户角色列表，不能调用UserUtils类，所以需要传递用户信息
     *
     * @param token
     * @param user
     * @return
     */
    public List<Role> findMobileRoleList(String token, User user) {
// 先检查是否有缓存
        List<Role> roleList = new ArrayList<Role>();
//        if (StringUtils.isNotBlank(token)) {
//            roleList = (List<Role>) EhCacheUtils.get(MOBILE_CACHE_ROLE_LIST, token);
//        }
...
//                        EhCacheUtils.put(MOBILE_CACHE_ROLE_LIST, token, roleList);
//                    }
//
//                }
            }
